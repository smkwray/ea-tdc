...
# EA-TDC-owned narrow internal screening config for the one refined macro-price
# target that still looked marginally viable under canonical public TDC.
...
OUT_DIR = str(
    EA_TDC_ROOT / "output" / "econark_dass" / "macro_prices_confirmatory_baaff_tdc"
)
