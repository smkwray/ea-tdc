...
# repo spread from the EA-TDC quarterly bundle instead of the parity panel.
...
_TMLE_VARIANTS = [
    {
        "w_tag": "tmle_ct_base_macro_prices_refined",
        "density_floor": 0.05,
        "h_clip": 8.0,
        "epsilon_cap": 0.5,
        "nuisance_r2_floor": 0.02,
    ...
    {
        "w_tag": "tmle_ct_loose_overlap_macro_prices_refined",
        "density_floor": 0.02,
        "h_clip": 10.0,
        "epsilon_cap": 0.75,
    ...
    {
        "w_tag": "tmle_ct_tight_overlap_macro_prices_refined",
        "density_floor": 0.10,
        "h_clip": 6.0,
        "epsilon_cap": 0.35,
...
OUT_DIR = str(
    EA_TDC_ROOT / "output" / "econark_dass" / "macro_prices_confirmatory_refined"
)
