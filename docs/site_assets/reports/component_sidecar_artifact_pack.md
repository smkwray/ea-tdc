...
Table export: `component_sidecar_reduced_form_table.csv`
...
Table export: `component_sidecar_liquidity_table.csv`
...
Table export: `component_sidecar_state_probe_table.csv`

- `matched_total_deposits` at `h=4`: `interaction beta ≈ 0.841818`, `interaction p ≈ 0.09533`
...
- `matched_total_deposits` at `h=4`: `interaction beta ≈ -0.164241`, `interaction p ≈ 0.008`
