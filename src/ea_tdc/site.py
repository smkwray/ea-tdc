...
def _home_html(generated_at: str) -> str:
    return "\n".join(
        [
            ...
            '<p>The public package is intentionally narrow: the normal-forward Assumption Mode coefficient 0.342 [0.116, 0.569] is the default downstream value; latest rolling 0.531 [0.146, 0.915] and pooled pandemic-inclusive 0.616 [0.220, 1.013] are references only; the same-treatment residual is a perimeter/plumbing-sensitive offset; broad mortgage/core-loan crowding-out is weak after selected lags, and consumer credit remains a guarded candidate margin.</p>',
            "</div>",
            '<div class="insight-grid"><article class="insight-card reveal"><div class="eyebrow">Default</div><h3>Normal-forward deposit response.</h3><p>Assumption Mode default: 0.342 [0.116, 0.569]. Pooled 0.616 is pandemic-inclusive historical reference only.</p></article><article class="insight-card reveal"><div class="eyebrow">Boundary</div><h3>Residual is not a channel.</h3><p>The same-treatment non-TDC deposit component is treated as perimeter and plumbing-sensitive.</p></article><article class="insight-card reveal"><div class="eyebrow">Credit</div><h3>Broad crowding-out weakens.</h3><p>Mortgage and strict core-loan rows are weak after selected lags; consumer credit is guarded.</p></article><article class="insight-card reveal"><div class="eyebrow">Sensitivity</div><h3>Older baseline preserved.</h3><p>The K=200 baseline branch is retained as an appendix sensitivity, not the main surface.</p></article></div>',
            "</section>",
            ...
            '<p>This figure traces the selected-lag Tier 2 deposit response (the pooled, pandemic-inclusive historical reference) and the same-treatment non-TDC deposit offset; the downstream default remains the normal-forward Assumption Mode coefficient 0.342.</p>',
            "</div>",
